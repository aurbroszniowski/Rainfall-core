...
public class RangeMapTest {
  ...
  public void testMultipleWeights() {
    ...
    assertThat("0.10 belongs to range [0, 0.20[, it should return the first value.", map.get(0.10f), is(equalTo("Value1")));
    assertThat("0.20 belongs to range [0.20, 0.50[, it should return the second value.", map.get(0.20f), is(equalTo("Value2")));
